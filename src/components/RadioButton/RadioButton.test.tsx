...
describe("RadioButton component", () => {
    it("renders the content prop", () => {
        ...
        const { getByText } = render(<RadioButton content={content} value="1" setValue={() => {}} />)
    ...
    it("calls the setValue prop with the correct value when radio button is clicked", () => {
        ...
        const { getByLabelText } = render(<RadioButton content="Option 2" value={value} setValue={setValue} />)
